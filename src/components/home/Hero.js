...
export default class Hero extends React.Component {
    ...
    componentDidMount() {
        ...
        this.heroTL.staggerFrom(this.pattern.children, .5, { opacity: 0, scale: .3, transform: "rotate(-90deg)" }, .01, "Start")
        this.heroTL.staggerFrom(this.intro.children, 1, { opacity: 0, transform: "translateY(15px)" }, .5, "Start");
        this.heroTL.staggerFrom(this.action.children, 1, { opacity: 0, transform: "translate(15px)" }, .5);
        this.heroTL.play();
    }
